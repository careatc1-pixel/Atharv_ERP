...
app = Flask(__name__)
app.secret_key = "atharv_tech_pro_v6_final"
...
def create_invoice():
    try:
        ...
        return f"Billing Error: {str(e)}", 500
...
def download_pdf(tid):
    try:
        ...
        if t.narration:
            ...
            pdf.set_font("Arial", '', 9); pdf.multi_cell(190, 5, str(t.narration))
        ...
        return f"PDF Internal Error: {str(e)}", 500
