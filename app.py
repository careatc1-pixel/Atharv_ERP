...
app = Flask(__name__)
app.secret_key = "atharv_tech_final_v6"
...
class Transaction(db.Model):
    ...
    narration = db.Column(db.Text) # New Field for Narration
...
def download_pdf(tid):
    try:
        ...
        if t.narration:
            pdf.ln(10); pdf.set_font("Arial", 'B', 9); pdf.cell(190, 5, "Narration/Note:", ln=True)
